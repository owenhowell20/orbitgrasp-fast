...
def train(config):
    ...
    if config['orbit_grasper']['load'] != 0:
        load_name = find_checkpoint(config["orbit_grasper"]["param_dir"],
                                    config['orbit_grasper']['load'])
...
if __name__ == '__main__':
    ...
    config['test_dataset']['load_harmony_path'] = base_path / config['test_dataset']['load_harmony_path']
    config['orbit_grasper']['param_dir'] = base_path / config['orbit_grasper']['param_dir']
