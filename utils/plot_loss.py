...
plt.plot(
    valid_loss_w_aug_wo_crop,
    label="no larger neighborhoods",
    color=colors[2],
    linewidth=2,
    marker="o",
    markersize=6,
...
plt.plot(
    valid_acc_ours, label="ours", color=colors[3], linewidth=3, marker="d", markersize=6
)
