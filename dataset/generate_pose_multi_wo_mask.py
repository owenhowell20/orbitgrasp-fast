...
def run(scene, object_set, iteration_num, savePath, start=0, GUI=True, n_intervals=36):
    sim = ClutterRemovalSim(scene, object_set, gui=GUI, rand=True, seed=start, load_sam=False, n_intervals=n_intervals)
    ...
    for itr in trange(iteration_num, desc='Iteration'):
        ...
        down_pcd, down_gt_segs = voxel_down_sample(combined_pcd, voxel_size=0.0055,
